    ...
    tenantUrls.innerHTML = `
                <h3> Tenant URLs</h3 >
                    <ul>
                        ...
                        <li><a href="${host + '/shell/b2bmonitor/landing'}" target="_blank">B2B Monitor</a></li>
                        ...
                        <li><a href="${host + '/shell/tpm/companyProfile'}" target="_blank">Integration Advisor</a>
                            <ul><li><a href="${host + '/shell/mags'}" target="_blank">Mappings (MAGs)</a></li></ul>
                            <ul><li><a href="${host + '/shell/migs'}" target="_blank">Messages (MIGs)</a></li></ul>
                            <ul><li><a href="${host + '/shell/customtypesystems'}" target="_blank">Custom Types</a></li></ul>
                        </li>
