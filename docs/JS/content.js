...
const prev_feature = [
  {
    ...
    description: "Conveniently view processed messages alongside your integration flow design.",
    image: "chrome1.png",
  },
  {
    caption: "Activate InlineTrace",
    description: "Enable InlineTrace to visualize the message route directly within the integration flow designer.",
    image: "chrome_inlinetrace_small.png",
  },
  {
    caption: "Direct Trace Message Viewing",
    description: "Instantly access and review trace messages within the integration flow designer interface.",
    image: "chrome_trace_properties_small.png",
  },
  {
    caption: "Pretty Print for Trace Messages",
    description: "Enhance readability with formatted trace messages directly in the integration flow designer.",
    image: "chrome_after_beautify_small.png",
  },
  {
    caption: "Trace Switch Button",
    description: "Seamlessly toggle trace functionality on and off with a dedicated switch button.",
    image: "chrome_inlinetrace_small2.png",
  },
  {
    caption: "Direct Access to Message Traces",
    description: "Quickly navigate to specific message traces without leaving the integration flow designer.",
    image: "messages.png",
  },
  {
    caption: "Logs and Attachments Access",
    description: "Easily access logs and attachments associated with specific messages right from the integration flow designer.",
    image: "",
  },
  {
    caption: "Error Message Pop-up",
    description: "Get instant error message pop-ups when hovering over messages in the sidebar, aiding in quick issue identification.",
    image: "chrome4.png",
  },
  {
    caption: "Deployment Info Pop-up",
    description: "Stay informed with deployment information through convenient pop-ups.",
    image: "chrome2.png",
  },
  {
    caption: "Useful Links in Browser Bar Popup",
    description: "Access relevant links directly from the browser bar popup for enhanced navigation and productivity.",
    image: "chrome3.png",
  },
  {
    caption: "Last Visited iFlows",
    description: "Keep track of your last visited integration flows for quick reference and easy access.",
    image: "",
  },
];
const stats_cards = [
