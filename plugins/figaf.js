...
var plugin = {
    ...
    description:
        'Simplify your SAP Cloud Integration work with Figaf. Learn more at <a href="https://figaf.com" target="_blank">figaf.com</a>',
    settings: {
        FigafURL: { text: "Figaf URL", type: "textinput", scope: "browser" },
        FigafAgentSystemId: {
            text: "Figaf Agent System Id (optional)",
            type: "textinput",
            scope: "tenant"
        },
        icon: {
            src: "images/plugin_logos/figaf_logo-or3aup2a4kcerbzkw8qe9fj133kv700baqsm2nnpj4.png",
            type: "icon"
        }
    },
    messageSidebarButton: {
        ...
        onClick: (pluginHelper, settings, runInfo, active) => {
            var currentIflowId = pluginHelper.currentIflowId
                ? pluginHelper.currentIflowId
                : pluginHelper.lastVisitedIflowId;
            var figafHost = getFigafHost(settings);
            var figafAgentSystemId = getFigafAgentSystemId(
                pluginHelper,
                settings
            );
    ...
    scriptCollectionButton: {
        ...
        onClick: (pluginHelper, settings) => {
            ...
            var resourceNameElement = document.querySelector(
                'bdi[id$="--ceFileLabel-bdi"]'
            );
    ...
    scriptButton: {
        ...
        onClick: (pluginHelper, settings) => {
            ...
            var artifactTechnicalName = pluginHelper.currentIflowId
                ? pluginHelper.currentIflowId
                : pluginHelper.lastVisitedIflowId;
