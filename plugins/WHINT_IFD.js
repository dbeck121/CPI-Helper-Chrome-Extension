var plugin = {
  ...
  messageSidebarContent: {
    ...
    onRender: (pluginHelper, settings) => {
      ...
      a.setAttribute("href", settings[`WHINT_IFD---${pluginHelper.tenant}---spBaseUrl`] + "/" + path[path.length - 3] + settings[`WHINT_IFD---${pluginHelper.tenant}---spSep`] + pluginHelper.integrationFlowId + ".pdf?web=1");
