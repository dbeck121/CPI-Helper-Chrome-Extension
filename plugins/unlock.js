    ...
    messageSidebarContent: {
        onRender: (pluginHelper) => {
            ...
            button.addEventListener("click", async () => {
                ...
                var dataOfDesigntimeLocks = JSON.parse(
                    await makeCallPromise("GET", urlForResourceId, false)
                ).d.results;
                ...
                if (lock?.ResourceId != undefined) {
                    ...
                    <div class="ui large list">
                        ...
                        <div class="item">
                            <div class="content">
                                ...
                                <div class="description">${formatDate(
                                    lock.CreatedAt
                                )}</div>
                            </div>
                        </div>
                    ...
                    $.modal(
                        ...
                        async function (choice) {
                            try {
                                dataOfDesigntimeLocks = JSON.parse(
                                ...
                                //get resourceid by matching the artifactid
                                var lock = dataOfDesigntimeLocks.find(function (
                                    a
                                ) {
                                    return (
                                        a.ArtifactId ===
                                ...
                                if (
                                    ...
                                    showToast(
                                        "The artifact has been unlocked",
                                        "",
                                        "success"
                                    );
                                } else if (
