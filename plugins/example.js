var plugin = {
    ...
    messageSidebarContent: {
        ...
        onRender: (pluginHelper, settings) => {
            ...
            button.onclick = (x) =>
                pluginHelper.functions.popup(popupContent, "Header");
    ...
    scriptCollectionButton: {
        ...
        onClick: (pluginHelper, settings) => {
            ...
            //better:
            log.log(
                document.querySelector('bdi[id$="--ceFileLabel-bdi"]')
                    .textContent
            );
        },
    ...
    heartbeat: async (pluginHelper, settings) => {
        console.log(
            "this function is running every 3 seconds because of example plugin"
        );
    }
};
